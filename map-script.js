...
async function handleAdversity() {
    ...
    if (adversityPosition > totalAdversitySteps) {
        ...
        //當逆境=1
        if(adversityPosition === 1){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 1); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 2){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 2); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 3){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 3); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 4){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 4); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 5){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 5); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 6){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 6); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }else if(adversityPosition === 7){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 7); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }
        else if(adversityPosition === 8){
            diveLinker_event.setInput("2187a5a0cee74cfca74c9f0608778344", 8); // 逆境號碼
            diveLinker_event.setInput("69cea17f848948419bc05d4ba5adcfcf", 1); // 顯示逆境事件
            diveLinker_event.setInput("1b1feb0b3da64daaabcc29c1a62d53ed", 0); // 重置事件框判斷
        }
        event_show(); // 顯示事件框
